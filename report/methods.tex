...
Of particular, the costs assumed in the model configuration for each technology 
drove the cost optimization. Table \ref{tab:costs_table} shows the cost 
...
no carbon limit, while the carbon constrained cases (CC) assume a zero 
