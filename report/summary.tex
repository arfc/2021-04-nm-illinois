...
The energy generation mixtures that minimized cost in each scenario 
demonstrated that:
\begin{itemize}
...
%Additionally, the economic value provided by these plants to the surrounding community will be lost \cite{economic_impact_studies}. 
