...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
    ...
    \vspace{0.2cm}
     \begin{minipage}{0.4\textwidth}
        ...
        {\begin{flushright}\huge\bfseries Economic and Carbon Impacts of Potential Illinois Nuclear Plant Closures}
                           \end{flushright}}
        {\begin{flushright}\large\textit{}\end{flushright}}
        \end{minipage}
    ...
    {\large April 15, 2021} % January 1, 3000
...
%------------------------------------------------
    ...
    policymakers about the clear benefits of nuclear energy. Contract Number NN-NNNN.} 
